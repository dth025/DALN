...
<head>
    ...
    <title>Đăng nhập Bác sĩ — HealthAI</title>
...
<body class="antialiased min-h-screen relative flex items-center justify-center p-4 overflow-x-hidden">
    ...
    <div class="w-full max-w-md glass rounded-3xl p-6 md:p-10 shadow-glow relative overflow-hidden">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-extrabold tracking-tight">Cổng thông tin <span class="gradient-text">Bác sĩ</span></h1>
            <p class="text-slate-400 text-xs mt-2">Đăng nhập tài khoản bác sĩ để quản lý bệnh nhân</p>
        </div>
        ...
        <form method="POST" action="{{ route('doctor.login.submit') }}" class="space-y-6">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <input id="email" name="email" type="email" value="{{ old('email') }}" placeholder="VD: doctor@healthai.vn" required class="h-11 w-full rounded-xl border border-slate-700 bg-slate-900/50 pl-10 pr-4 text-xs font-semibold outline-none transition-all focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10">
                </div>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <input id="password" name="password" type="password" placeholder="••••••••" required class="h-11 w-full rounded-xl border border-slate-700 bg-slate-900/50 pl-10 pr-4 text-xs font-semibold outline-none transition-all focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10">
                </div>
            </div>
        ...
        <div class="mt-8 text-center border-t border-slate-800 pt-6 text-xs">
            <span class="text-slate-400">Chưa có tài khoản bác sĩ?</span>
            <a href="{{ route('doctor.register') }}" class="text-sky-400 hover:text-sky-300 font-bold ml-1 transition-colors">Đăng ký ngay</a>
        </div>
    </div>
